						...
						<ul>
							<c:forEach items="${list}" var="vo">
								<div class="Access_Records_container_div">
									...
									<!-- 경로 확인 하기..... -->
									<video width="100%"
											src="../../pyoripass/resources/video/2022-08-17T14.47.57.873.mp4#t=0.5"></video>
										<br> 
										<p>
										<a
										href="${cpath}/invasionInformationForm.do?invasion_seq=${vo.invasion_seq}">${vo.invasion_time}</a></p>
									</li>
								</div>
							</c:forEach>
						</ul>
